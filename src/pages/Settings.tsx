        ...
        <div className="space-y-8">
          ...
          >
            <div className="flex items-center gap-4 px-5 py-5">
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white font-bold text-xl shadow-lg shadow-indigo-500/30">
              ...
              <button
                ...
                className="hidden sm:inline-flex min-h-10 items-center gap-1.5 px-4 rounded-xl bg-slate-100 dark:bg-gray-800 text-slate-700 dark:text-gray-200 text-sm font-semibold active:scale-[0.98] md:hover:bg-slate-200 md:dark:hover:bg-gray-700 transition-all"
              >
                Edit
              </button>
            </div>
            ...
            <Row
              ...
              right={
                <Toggle
                  ...
                  onChange={() => {
                    toggleDarkMode();
                    toast.success(darkMode ? "Light mode on" : "Dark mode on");
                  }}
                />
              }
            />
              ...
              {languageOptions.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full min-h-[68px] flex items-center justify-between gap-3 px-5 py-3.5 text-left transition-colors ${
                      selected
                  ...
                  >
                    <div className="flex items-center gap-4 min-w-0">
                      <div
                        className={`w-12 h-12 shrink-0 rounded-2xl flex items-center justify-center overflow-hidden transition-all ${
                          selected
                    ...
                    {selected ? (
                      <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="w-6 h-6 shrink-0 rounded-full bg-indigo-600 flex items-center justify-center shadow-md shadow-indigo-500/30"
                      >
                        <FiCheck className="w-3.5 h-3.5 text-white" />
                      </motion.div>
                    ) : (
                      <div className="w-6 h-6 shrink-0 rounded-full border-2 border-slate-200 dark:border-gray-700" />
                    )}
                  </button>
                );
              })}
          ...
          >
            <button
              ...
              className="w-full min-h-[56px] flex items-center justify-center gap-2 px-5 py-4 text-rose-600 dark:text-rose-400 font-semibold text-sm active:bg-rose-50 dark:active:bg-rose-900/20 md:hover:bg-rose-50 md:dark:hover:bg-rose-900/20 transition-colors"
            >
          ...
          <div className="text-center pt-4">
            ...
            <Link
              to="/"
              className="mt-2 inline-flex items-center gap-1 text-xs font-medium text-indigo-600 dark:text-indigo-400 md:hover:underline"
            >
        ...
        {activeModal === "terms" && (
          <InfoModal
            ...
            content={
              <>
                <p>
                  By using LendFlow, you agree to the following terms:
                </p>
                <p className="mt-3">
...
const Section: React.FC<{
  ...
  <section>
    <div className="flex items-start gap-3 mb-3 px-1">
      <div className="w-8 h-8 shrink-0 rounded-lg bg-slate-100 dark:bg-gray-800 text-slate-600 dark:text-gray-300 flex items-center justify-center text-sm mt-0.5">
        {icon}
      </div>
      <div>
...
const ActionRow: React.FC<{
  ...
  <div className="flex items-center justify-between gap-4 px-5 py-3.5 min-h-[52px]">
    <div className="flex items-center gap-3 min-w-0 flex-1">
      ...
      <span className="text-sm text-slate-600 dark:text-gray-300 shrink-0">
        {label}
      </span>
    </div>
...
const NavRow: React.FC<{
  ...
  <button
    type="button"
    onClick={onClick}
    className="w-full min-h-[56px] flex items-center justify-between gap-3 px-5 py-3.5 text-left transition-colors active:bg-slate-50 dark:active:bg-gray-800/50 md:hover:bg-slate-50 md:dark:hover:bg-gray-800/50"
  >
    <div className="flex items-center gap-3.5 min-w-0 flex-1">
      {icon && (
        <span className="text-slate-400 dark:text-gray-500 text-base shrink-0">
          {icon}
        </span>
      )}
      <div className="min-w-0">
  ...
  >
    ...
    >
      <div
        ...
        } flex flex-col justify-center px-3 gap-2`}
      >
        <div
